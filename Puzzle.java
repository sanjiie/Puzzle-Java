...
class puzzle extends JFrame implements ActionListener {
    ...
    Timer timer;  // Timer for tracking the game time
    int seconds;  // Variable to store the elapsed seconds
    String playerName;  // Variable to store the player's name

    puzzle() {
        super("puzzle game");
        playerName = JOptionPane.showInputDialog(this, "Masukkan Username:   ");
        ...
        timer = new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                seconds++;
                setTitle("puzzle game - Time: " + seconds + " seconds");
            }
        });
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b9) {
            ...
            if (b1.getLabel().equals("1") && b2.getLabel().equals("2") && b3.getLabel().equals("3") && b4.getLabel().equals("4") && b5.getLabel().equals("5") && b6.getLabel().equals("6") && b7.getLabel().equals("7") && b8.getLabel().equals("8") && b9.getLabel().equals(" ")) {
                ...
                JOptionPane.showMessageDialog(puzzle.this, "Congratulations, " + playerName + "!\nYou won!\nTime taken: " + seconds + " seconds");

                // Save the time and player's name to a text file
                saveScoreToFile(playerName, timeInSeconds);
            }
        }
    }

    private void saveScoreToFile(String playerName, int timeInSeconds) {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("game_scores.txt", true))) {
            writer.write("Player: " + playerName + ", Time taken: " + timeInSeconds + " seconds");
            writer.newLine();
        } catch (IOException e) {
            e.printStackTrace();
        }
